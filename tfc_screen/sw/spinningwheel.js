...
var SpinningWheel = {
	...
	create: function () {
		...
		div.innerHTML = '<div id="sw-header"><div id="sw-cancel">Cancelar</' + 'div><div id="sw-done">Confirmar</' + 'div></' + 'div><div id="sw-slots-wrapper"><div id="sw-slots"></' + 'div></' + 'div><div id="sw-frame"></' + 'div>';
	...
	getSelectedValues: function () {
		...
		for (i in this.slotEl) {
			...
			t=1;
			}else{dist.push(this.slotData[i].values[l]);}
			break;
			}
			count += 1;
			}
